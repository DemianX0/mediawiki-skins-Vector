...
/**
 * Execute an API request to save the sidebar user preference.
 * The request is meant to be fired 1 second after the last click on
...
function init( window ) {
	...
	var saveSidebarState = saveSidebarLocalState; // Logged out.
	var saveSidebarServerState;
	...
	if ( checkbox instanceof HTMLInputElement && button ) {
		...
		if ( window.mwSidebarInitialState !== undefined &&
